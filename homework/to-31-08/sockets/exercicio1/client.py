...
print(client.send_message(json.dumps({ 'salario': 6600.00, 'cargo': 'operador', 'nome': 'Igor'})))
print(client.send_message(json.dumps({ 'salario': 6600.00, 'cargo': 'programador', 'nome': 'Igor'})))